const initialState = [
    {id: 0, contents: 'CPU', visible: true, matched: true}, 
    {id: 1, contents: 'CPU', visible: true, matched: true}, 
    {id: 2, contents: 'GPU', visible: true, matched: true}, 
    {id: 3, contents: 'GPU', visible: true, matched: true}, 
    {id: 4, contents: 'RAM', visible: true, matched: true}, 
    {id: 5, contents: 'RAM', visible: true, matched: true}, 
    {id: 6, contents: 'Motherboard', visible: true, matched: true}, 
    {id: 7, contents: 'Mothorboard', visible: true, matched: true}, 
    {id: 8, contents: 'Waterblock', visible: true, matched: true}, 
    {id: 9, contents: 'Waterblock', visible: true, matched: true}, 
    {id: 10, contents: 'Heatsink', visible: true, matched: true}, 
    {id: 11, contents: 'Heatsink', visible: true, matched: true}, 
  ];
